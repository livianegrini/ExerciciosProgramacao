...
class GameScene2 extends Phaser.Scene {
    ...
    create() {
        ...
        const map = this.make.tilemap({ moeda: "map" });
        const tileset = map.addTilesetImage("tileset", "tiles");
        map.createLayer("Ground", tileset, 0, 0);
        this.add.text(100, 100, "Fase 2 - Novo Desafio", { fontSize: "15px", fill: "#fff" });
    ...
    spawnKey() {
        ...
        let x = Phaser.Math.Between(50, 750);
        let y = Phaser.Math.Between(50, 550);
        this.keyItem = this.physics.add.sprite(x, y, 'moeda');
        this.physics.add.overlap(this.player, this.keyItem, this.collectKey, null, this);
        this.hasKey = false;
    }

    collectKey(player, moeda) {
        this.score += 10;
        this.scoreText.setText('Placar: ' + this.score);
        moeda.destroy();
        this.hasKey = true;
